...
export default function TableHeader({
    ...
    showExport = true,
    showButton = true,
    onStatusFilter, // ✅ receives callback from parent
}: TableHeaderProps) {
                                                    ...
                                                    {excelFile && (
                                                        <div className="flex items-center shadow-lg rounded-md lg:py-3 py-2 px-6 bg-slate-100 dark:bg-slate-800 justify-between">
                                                            <div className="flex items-center gap-3">
                                                                <div className="w-8 h-8 lg:w-14 lg:h-14 p-2 lg:p-4 bg-slate-300 dark:bg-slate-500 rounded flex items-center justify-center shrink-0">
